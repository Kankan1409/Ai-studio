...
export const INITIAL_EMPLOYEES: Employee[] = [
  ...
  },
  {
    ...
    name: 'ข้าวหอม',
    phone: '089-112-3344',
    projectId: 'AI-001,AI-002,AI-003',
    project: 'AI-001,AI-002,AI-003',
    email: 'khaohom@company.com',
    role: 'Team Member',
...
export const INITIAL_TASKS: Task[] = [
  {
    id: 'AI-001',
    title: 'พัฒนาระบบ AI Automation และประมวลผลข้อมูล',
    category: 'โครงการ AI',
    project: 'AI-001',
    priority: 'High',
    status: 'In progress',
    ...
    ownerEmail: 'khaohom@company.com',
    techStack: 'Python, OpenAI, Fastify',
    startDate: '2026-09-01',
    dueDate: '2026-09-15',
    duration: '14 วัน',
    description: 'พัฒนาระบบเชื่อมต่อ API และโมเดล AI เพื่อช่วยสรุปงานอัตโนมัติ',
    resultOutcome: 'กำลังทดสอบเชื่อมต่อ API',
    projectLink: 'https://github.com',
    progress: 60,
    progressBar: '60%',
    subtasks: [
      { id: 'st-ai1', title: 'ตั้งค่า Prompt Template', completed: true, assignee: 'ข้าวหอม' },
      { id: 'st-ai2', title: 'ทดสอบการส่งข้อมูลผ่าน Webhook', completed: false, assignee: 'ข้าวหอม' },
    ],
  ...
  {
    id: 'AI-002',
    title: 'ทดสอบโมเดลจัดหมวดหมู่งานอัตโนมัติ (Classifier)',
    category: 'โครงการ AI',
    project: 'AI-002',
    priority: 'Medium',
    status: 'Completed',
    ...
    ownerPhone: '089-112-3344',
    ownerEmail: 'khaohom@company.com',
    techStack: 'Transformers, Pandas',
    startDate: '2026-08-20',
    dueDate: '2026-08-31',
    duration: '11 วัน',
    description: 'ทดสอบความแม่นยำในการคัดแยกประเภทตั๋วงาน',
    resultOutcome: 'ผ่านเกณฑ์ Accuracy 94%',
    projectLink: 'https://huggingface.co',
    progress: 100,
    progressBar: '100%',
    subtasks: [
      { id: 'st-ai2-1', title: 'รวบรวม Data ชุดทดสอบ', completed: true, assignee: 'ข้าวหอม' },
      { id: 'st-ai2-2', title: 'รัน Benchmark ทดสอบผล', completed: true, assignee: 'ข้าวหอม' },
    ],
  ...
  {
    id: 'AI-003',
    title: 'จัดทำคู่มือการใช้งานระบบ AI Assistant สำหรับทีม',
    category: 'โครงการ AI',
    project: 'AI-003',
    priority: 'Low',
    status: 'Todo',
    ...
    dueDate: '2026-09-20',
    duration: '10 วัน',
    description: 'เขียนเอกสารและ Workflow แนะนำขั้นตอนการใช้งาน',
    resultOutcome: 'ร่างโครงสารบัญเอกสารเรียบร้อย',
    projectLink: 'https://notion.so',
    progress: 20,
    progressBar: '20%',
    subtasks: [],
